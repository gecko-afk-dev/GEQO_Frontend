        ...
        <div class="flex items-center justify-center min-h-screen animated-bg">
            <div class="glass p-8 rounded-2xl shadow-2xl w-full max-w-md card-hover">
                <div class="text-center mb-8 flex flex-col items-center">
                    <img src="/img/geqo-emblem.svg" alt="GEQO Setae Mark" class="w-16 h-16 mb-4 rounded-xl shadow-lg object-contain" />
                    <h1 class="text-3xl font-extrabold text-slate-800 tracking-tight" style="font-family: 'Space Grotesk', 'Plus Jakarta Sans', sans-serif; letter-spacing: -0.02em;">
